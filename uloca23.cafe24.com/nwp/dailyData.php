...
<body>
		...
		<div class="detail_search">
			<form action="/g2b/datas/dailyDataSearch.php" name="myForm" id="myForm" method="post">
				...
				<table align=center cellpadding="0" cellspacing="0" width="100%">
					...
					<tbody>
						<tr colspan><font size=4em align='center'> 일일자료수집 </font></tr>
						<tr>
							<th>Table Name</th>
							<td>
						...
						<tr>
							...
							<td>
								...
								<? if ($mobile != "Mobile") { ?>
								<br>일시 포맷은 yyyy-mm-dd hh:mm 혹은 yyyymmdd hhmm, 하루치 입찰공고 건수가 약 1,500-2,000건이고 그 응찰 건수는 약 10만건이 넘습니다. 입찰공고 수집후 개찰정보가 수집, 목록이 보인후 응찰건수가 한 라인별로 계산<br>
								<input type="checkbox" name="oldDataCheck" value="과거데이터수집" id="oldDataCheck" <?php if ($oldDataCheck) {echo 'checked';} ?> />
								(체크되어 있으면 5초 마다 반복 실행)
								<? } ?>
							</td>
						</tr>
	...
	<script>
		...
		function searchDaily_tmp(func) {
			...
			// 임시테이블 처리 
			var url = '/g2b/datas/dailyDataHandle.php?func=' + func + '&openBidInfo=' + openBidInfo + '&openBidSeq=' + openBidSeq + '&openBidSeq_tmp=' + openBidSeq_tmp;
			move();
		...
		var urlDailydata = '/nwp/dailyData.php';
		var mywin;
