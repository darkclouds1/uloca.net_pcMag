...
function viewscs(dminsttNm) {
	...
	duridx = -1;
	curStart = 0;
	clog('viewscs detailsw='+detailsw+' frm.dminsttNm.value='+frm.dminsttNm.value+' frm.kwd.value='+frm.kwd.value+' dminsttNm='+dminsttNm);
	if (detailsw == true)
	{
		searchajax000(); // 검색 버튼 상세
	} else  searchajax0_1(); // 검색 버튼 통합
