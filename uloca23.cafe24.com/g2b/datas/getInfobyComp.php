...
function mydrawChart() {
	...
	myLineChart =  new dhtmlXChart({
		...
		legend:{
          values:[
            {text:"당사",color:"#1293f8"},
            {text:"1순위",color:"#E9602C"}
        ],
		valign:"bottom",
		align : 'center',
        layout:"x"
...
?>
<body> <!--onload='mydrawChart();'> //차트삭제 -jsj 190518  -->
<!-- 
...
<!-- //chart box 젤하단으로 이동 -by jsj 190518  --> 
<!-- 
<div style="overflow:auto; width:98%; height:280px; padding:10px; background-color:#eeeeee;">
	<div id="chartbox" style="width:2400px;height:250px;border:1px solid #c0c0c0;"></div>
</div> 
-->
...
//echo $json_rs;
	...
	while ($row = $result->fetch_assoc() ) {
		...
		} else { $colordate = ' style="color:black; font-weight:normal; font-size:10px;"';}
