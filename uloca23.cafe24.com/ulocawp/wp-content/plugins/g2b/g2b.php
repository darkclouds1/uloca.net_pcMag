...
<style>
.btnorange1 { height:25px; width:80px; font-size:14px; line-height:25px; color:#fff; text-align:center;  background-color:#E9602C; border:0; vertical-align:middle; cursor:pointer;}
</style>
...
<form action="g2b.php" name="myForm" id="myForm" method="get" >  <!-- get 방식 테스트 -by jsj 190318  --> 
<div id="contents">
