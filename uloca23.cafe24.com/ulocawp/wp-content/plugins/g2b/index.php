...
<head>
	...
	<meta name="google-site-verification" content="AM7E7-wy16quF9KlaALtkFeDaRHN5f1YaLPYqw2Sxfc" />
				...
				<td>
					...
					<!-- input type="radio" name="bidrdo" value="scsbid" <? if ($bidrdo == 'scsbid') { ?> checked="checked" <? } ?> >낙찰 -- >
						...
						<tr>
							<th>검색종류</th>
							<td>
								<input class="chkboxx" type="checkbox" id="chkBid" name="chkBid" value="bid" <? if ($chkBid == 'bid') { ?> checked <? } ?> /><label for='chkBid' style='font-size:16px; font-weight: bold;vertical-align:text-bottom'>입찰</label>
								<input class="chkboxx" type="checkbox" id="chkHrc" name="chkHrc" value="hrc" <? if ($chkHrc == 'hrc') { ?> checked <? } ?> /><label for='chkHrc' style='font-size:16px; font-weight: bold;vertical-align:text-bottom'>사전규격</label>
							</td>
						</tr>
						<tr>
							<th>수요기관</th>
...
$item4 = $json4['response']['body']['items']; */
		...
		<center>
			<div style='font-size:18px;'>
				<font color='blue'><strong>- 입찰 정보 -</strong></font>
		</center>
		<div id=totalrec></div>
	...
	?>
		...
		<center>
			<div style='font-size:18px;'>
				<font color='blue'><strong>- 사전규격 정보 -</strong></font>
		</center>
