						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<? if ($mobile != "Mobile") { ?>
										<br>일시 포맷은 yyyy-mm-dd hh:mm 혹은 yyyymmdd hhmm 입니다.
										<!-- p style='color:red;font-size:11px;'>업무시간외에 실행 시키는 것이 좋습니다. 한번에 4시간이내로 하십시요.</p -->
										...
										<input type="checkbox" name="oldDataCheck" value="과거데이터수집" id="oldDataCheck" <?php if ($oldDataCheck) {
																															echo 'checked';
																														} ?> />
