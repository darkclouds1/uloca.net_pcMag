...
<head>
	...
	<script type="text/javascript">
		...
		window.onload = function() {
			...
			<? if ($_GET['compno'] == "") { $compno="1248100998";  } 
		...
		function makecomptable(xml) {
			...
			try
			{
				...
				if (Err != "00")
				{
					clog("err_cd="+Err+" err_info="+xml.getElementsByTagName('err_info')[0].innerHTML);
					alert("err_cd="+Err+" err_info="+xml.getElementsByTagName('err_info')[0].innerHTML);
					return;
				}
			}
			catch (e)
...
<body>
	...
	<table align=center class="grid06" style="text-align: left;  word-break:break-all;">
		<colgroup>
			<col style="width:25%;" /><col style="width:auto;" />
		</colgroup>
		<tbody>
			<tr>
				<th style='text-align:center; border-top:solid 1px #99bbe8; '>사업자등록번호</th>
				<td style='border-top:solid 1px #99bbe8;' id=bzno>&nbsp;
