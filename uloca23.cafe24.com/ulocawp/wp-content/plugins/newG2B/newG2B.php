...
<html>
    <head>
        ...
        <script>
            ...
            var col2 = ['','pss','bidNtceNo','bidNtceNm', 'cntrctCnclsMthdNm', 'presmptPrce', 'bidNtceDt', 'dminsttNm', 'bidwinnrNm', 'opengDt', 'check'            ];
            var col3 = ['c', 'c', 'c', 'l', 'l', 'r', 'd', 'l', 'c', 'd', 'c'];
            var colw = [ '5%', '6%', '10%', '20%', '10%', '7%', '7%', '10%', '9%', '9%', '5%'];
            // 사전규격 -----------------------------------------------
            var colsx = [ "번호", "등록번호", "품명", "계약방법", "예산금액", "등록일", "수요기관", "마감일시"];
        ...
        <form action="g2b.php" name="myForm" id="myForm" method="post">
                    ...
                    <table align="center" cellpadding="0" cellspacing="0" width="700px" id='choice'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>입찰정보</th>
                                <td>&nbsp;
                                    <input class="input_style2" autocomplete="on" type="text" name="kwd" id="kwd"
                                        size='20' style="width:80%;" value=""
                                        onkeypress="if(event.keyCode==13) {searchajax000(); return false;}"
                                        onclick="chBack(1)" maxlength="50" placeholder="키워드 2개입력(ex):정보 감리" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th>수요기관</th>
                                <td>&nbsp;
                                    <input class="input_style2" autocomplete="on" type="text" name="dminsttNm"
                                        id="dminsttNm" style="width:80%;" value=""
                                        onkeypress="if(event.keyCode==13) {searchajax000(); return false;}"
                                        onclick="chBack(1)" maxlength="50" />
                                </td>
                            </tr>
                            <tr>
                                <th>검색종류</th>
            ...
            <script>
                ...
                function init() {
                    ...
                    var selcolor = '#eeeeee'; var unselcolor = '#ffffff';
                    var choiceTable = '';
                    function chBack(ln) {
                        if (mobile == "mobile") {
