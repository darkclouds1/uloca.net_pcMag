...
<head>
    ...
    <meta http-equiv="refresh" content="1;url=http://uloca.net/ulocawp/?page_id=1134">
...
<body>
    <?
    session_start();
    $_SESSION['ServerAddr'] = 'http://uloca23.cafe24.com/';

    //header("Location: https://uloca.net/ulocawp/?page_id=337");   //uloca23
    header("Location: https://uloca23.cafe24.com/ulocawp/?page_id=1134");  //uloca22
