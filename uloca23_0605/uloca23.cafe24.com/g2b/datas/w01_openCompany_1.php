...
document.getElementById('strDate').value = '20200101';
document.getElementById('endDate').value = '20200110';
...
<body>
	...
	<div class='inputdate' id='inputdate'>
		<input type="text" name="strDate" id='strDate' value='20200101' style='text-align: center;' size=10/>
		<input type="text" name="endDate" id='endDate' value='20200110' style='text-align: center;' size=10/>
	</div>
	<div id='status'>
	</div>
	<div id='mydiv'>
