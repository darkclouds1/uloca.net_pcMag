<div id="kboard-pic-gallery-editor">
	<form class="kboard-form" method="post" action="<?php echo $url->getContentEditorExecute()?>" enctype="multipart/form-data" onsubmit="return kboard_editor_execute(this);">
		...
		<div class="kboard-attr-row">
			<label class="attr-name" for="secret"><?php echo __('Secret', 'kboard')?></label>
			<div class="attr-value"><input type="checkbox" id="secret" name="secret" value="true"<?php if($content->secret):?> checked<?php endif?>></div>
		</div>
		...
		<div class="kboard-control">
			<div class="left">
				<?php if($content->uid):?>
				<a href="<?php echo $url->getDocumentURLWithUID($content->uid)?>" class="kboard-pic-gallery-button-small"><?php echo __('Back', 'kboard')?></a>
				<a href="<?php echo $url->set('mod', 'list')->toString()?>" class="kboard-pic-gallery-button-small"><?php echo __('List', 'kboard')?></a>
				<?php else:?>
				<a href="<?php echo $url->set('mod', 'list')->toString()?>" class="kboard-pic-gallery-button-small"><?php echo __('Back', 'kboard')?></a>
				<?php endif?>
			</div>
			<div class="right">
...
<?php wp_enqueue_script('kboard-pic-gallery-script', "{$skin_path}/script.js", array(), KBOARD_VERSION, true)?>